        ...
        <form>
          {
            state === "Sign Up" && (
              <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
                ...
                <input type="text" placeholder='Fullname' required className='bg-transparent outline-none text-gray-200' />
              </div>
            )
          }
          ...
          <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
            ...
            <input type="email" placeholder='Enter email here' required className='bg-transparent outline-none text-gray-200' />
          </div>
          <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
            <img src={assets.lock_icon} alt="" />
            <input type="password" placeholder='Enter password' required className='bg-transparent outline-none text-gray-200' />
          </div>
